            ...
            <section className="space-y-6">
                ...
                {names.length > 0 && (
                    <div className="glass p-6 rounded-2xl border-white/10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <button
                            className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-5 rounded-2xl shadow-lg shadow-emerald-500/20 transition-all active:scale-95 text-xl flex items-center justify-center gap-3"
                        >
